...
*/        
       ...
       command_queue= clCreateCommandQueue(context, device_id, CL_QUEUE_PROFILING_ENABLE, &err);
        ...
        // data transfer rate
        double matrix_a_write_rate = (double) N*N*sizeof(value_t)*8 / (matrix_a_write_time/1000000000);
        double matrix_b_write_rate = (double) N*N*sizeof(value_t)*8 / (matrix_b_write_time/1000000000);
        double matrix_c_read_rate = (double) N*N*sizeof(value_t)*8 / (matrix_c_read_time/1000000000);
        // MFLOPs performance of the kernel
        mflops = (double) N*N*N*8 / (totalTime/1000); // 8 operation
        /*
